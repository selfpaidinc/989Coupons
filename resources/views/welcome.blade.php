...
@section('content')
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<h3 class="text-center lander">{{ __('app.subscribe_below') }}</h3>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 col-md-offset-3 text-center">
				<form method="POST" action="{{ url('/') }}" class="opt-form">
					...
					<div class="form-group">
						<input type="text" name="zip" class="form-control input-lg" pattern="[0-9]{5}" value="" placeholder="{{ __('app.zip_code') }}" required />
					</div>
					<div class="form-group">
